...
os.chdir(r"E:\AAFC Soils Data\Detailed_Soil_Survey_DSS_Compilations\dss_v3_ab_20140529")
...
# Opening DBF file1
print 'Reading: ', 'dss_v3_ab_cmp.dbf'
dbfFile1, dbfLayer1 = openingShpFile("dss_v3_ab_cmp.dbf")
# - Printing the field names
...
# Opening DBF file2
print 'Reading: ', 'soil_layer_ab_v2.dbf'
dbfFile2, dbfLayer2 = openingShpFile("soil_layer_ab_v2.dbf")
# - Printing the field names
