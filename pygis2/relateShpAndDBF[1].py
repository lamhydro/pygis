...
os.chdir(r"E:\AAFC Soils Data\Detailed_Soil_Survey_DSS_Compilations\dss_v3_mb_20130716")
...
# Opening DBF file1
print 'Reading: ', 'dss_v3_mb_cmp.dbf'
dbfFile1, dbfLayer1 = openingShpFile("dss_v3_mb_cmp.dbf")
# - Printing the field names
...
# Opening DBF file2
print 'Reading: ', 'soil_layer_mb_v2.dbf'
dbfFile2, dbfLayer2 = openingShpFile("soil_layer_mb_v2.dbf")
# - Printing the field names
