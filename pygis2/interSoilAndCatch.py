...
os.chdir(r"E:\AAFC Soils Data\ABandSK")

# Opening the catchment shapefile
file1 = r'E:\Red_deer_SPARROW\RiverNet2\CatchmentDef.shp'
...
file2 = 'AG30G_proj_dbf_and_dtl_100k_dbfRedDeer.shp'
...
i = 0
ofile  = open('E:\\Red_deer_SPARROW\\RiverNet2\\KSAT_IN_HR_ave.csv', "wb")
