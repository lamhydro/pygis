...
# Opening 
file0 = 'CatchmentDef.shp'
shfileCatch0, layer0 = openingShpFile(file0)
# - Getting the spatial projection
geoSRlayer0 = layer0.GetSpatialRef()
shfileCatch0.Destroy()

# Opening 
file = r'E:\Red_deer_SPARROW\GIS\redDeerRiverNHN.shp'
#file = "E:\\Red_deer_SPARROW\\RiverNet2\\CatchmentDef.shp"
shfileCatch, layer = openingShpFile(file)
# - Getting the spatial projection
geoSRlayer = layer.GetSpatialRef()


# Transforming SR of layer2 into layer1's
coordTrans = osr.CoordinateTransformation(geoSRlayer, geoSRlayer0)
...
maxPi=[]
geoMatrix=range(0,6)
ofile  = open('landUseSubSubBas.csv', "wb")
writer = csv.writer(ofile)
# Note: see file 'AAFC_LULC_Classes.csv' in the current dir for codes.
header = ['SUBSUBBASI','AAFCcode_20','AAFCcode_30','AAFCcode_31','AAFCcode_32','AAFCcode_33','AAFCcode_34','AAFCcode_40','AAFCcode_50','AAFCcode_51','AAFCcode_52','AAFCcode_80','AAFCcode_81','AAFCcode_82','AAFCcode_83','AAFCcode_110','AAFCcode_120','AAFCcode_121','AAFCcode_122','AAFCcode_210','AAFCcode_220','AAFCcode_230']
writer.writerow(header)
sumError = 0
while feature:

	WSCSSDANAM = feature.GetField('WSCSSDANAM')
