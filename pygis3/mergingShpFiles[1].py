...
# set directory
dir = r"W:\Luis\Colin_QuAppelle\effective_areas"
os.chdir(dir) 
...
listOfShpfiles = [os.path.join(dir,'05JG004_effective_area.shp'), 
				os.path.join(dir,'05JG005_effective_area.shp'), 
				os.path.join(dir,'05JG007_effective_area.shp'),
				os.path.join(dir, '05JG010_effective_area.shp'),
				os.path.join(dir, '05JG011_effective_area.shp'),
				os.path.join(dir, '05JG013_effective_area.shp'),
				os.path.join(dir, '05JG014_effective_area.shp')]
mergedFile = os.path.join(dir,'effective_area.shp')
projec = 1 
