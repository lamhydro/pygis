...
inDS = driver.Open(r'E:\Documents\NutrientsLecture2\Maps\Catchment.shp', 0)
if inDS is None:
  print 'Could not open file'
  sys.exit(1)
...
outLayer = outDS.CreateLayer('Catchment_proj', outSpatialRef, geom_type=ogr.wkbPolygon)
...
file = open('Catchment_proj.prj','w')#open('redDeerRiverNHN_proj.prj', 'w')
