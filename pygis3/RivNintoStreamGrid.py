...
gdal.AllRegister()
# open the image
ds = gdal.Open('MiryCreek_PrXY.tif')
if ds is None:
...
while feature:
	...
	# Geting the geometry of the polyline
	...
	data = band.ReadAsArray(j, i, ncols, nrows)*0 + 1 # by 0 + 1 to change z into 1 
